...
class hoadon
{
    function insertHoadDon($makh)
    {
        ...
        return $masohd[0]; // trá về array(14);
    }
    ...
    {
        $db = new connect();
        $select = "select a.masohd,b.tenkh,a.ngaydat,b.diachi,b.sodienthoai from hoadon a, khachhang b WHERE a.makh-b.makh and a.masohd=$masohd";
